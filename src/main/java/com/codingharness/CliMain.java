...
public class CliMain {
    ...
    private AgentLoopImpl buildAgentLoop() {
        // Build LLM provider (mock for dry-run)
        ...
        MockLlmProvider mockLlm = new MockLlmProvider(List.of(mockResponse));
        ...
        // Feedback sensor
        FeedbackSensor feedbackSensor = ctx -> FeedbackResult.allGood();

        return new AgentLoopImpl(mockLlm, tools, guardChain, feedbackSensor,
            config.maxTurns(), 3);
    }
